      ...
      {playerMinimap.map((player, index) => {
        ...
        return (
          ...
          >
            ...
            <span className='absolute bottom-0 z-10 p-1 text-center text-black transition-all scale-0 font-omg-event-content text-omg-14 break-keep left-11 rounded-5 bg-white2 group-hover:scale-100'>
              {player.nickname}
            </span>
          </div>
        );
