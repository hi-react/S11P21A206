    ...
    <div className='fixed top-0 left-0 z-50 flex items-center justify-center w-full h-full bg-opacity-70'>
      <div className='p-8 w-[70%] modal-container flex justify-between'>
        <div className="flex flex-col gap-10">
          ...
          <h3 className='text-center text-omg-24'>{nickname}님의 최종 순위는 <span className='text-red'>{rank}위</span> 입니다.</h3>
        </div>
        <div className='h-1/3'>
        ...
        <p className='text-center underline text-omg-11 font-omg-body'>* 총 자산은 보유 현금 자산과 주식 최종액, 금괴 매입액을 합산하고 대출액을 차감하여 산정합니다.</p>
      </div>
    </div>
  );
}
